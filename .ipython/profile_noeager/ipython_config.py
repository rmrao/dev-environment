...
c.InteractiveShellApp.exec_lines += ['%aimport -numpy', '%aimport -tensorflow', '%aimport -matplotlib', '%aimport -matplotlib.pyplot', '%aimport -random', '%aimport -sys', '%aimport -os']
...
#c.InteractiveShell.banner1 = "Python 3.6.2 |Anaconda custom (64-bit)| (default, Sep 30 2017, 18:42:57) \nType 'copyright', 'credits' or 'license' for more information\nIPython 6.1.0 -- An enhanced Interactive Python. Type '?' for help.\n"
